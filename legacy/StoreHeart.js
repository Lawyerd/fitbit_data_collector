...
async function getData(beforeDate, users) {
    ...
    const DETAIL_URI = `/1/user/-/activities/heart/date/${beforeDate}/1d/1min.json`
...
function cleanData(rawData, accessTokens) {
    ...
    for (let i in rawData) {
        ...
        new_data["dateTime"] = data["activities-heart"][0]["dateTime"]
        new_data["heartRateZones"] = data["activities-heart"][0]["value"]["heartRateZones"]
        new_data["restingHeartRate"] = data["activities-heart"][0]["value"]["restingHeartRate"]
        new_data["dataset"] = data["activities-heart-intraday"]["dataset"]
